...
return new class extends Migration
{
    ...
    {
        Schema::create('pembelian_biller_kartu_perdana', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('biller_kp_id');
            $table->foreign('biller_kp_id')->references('id')->on('biller_kartu_perdana');
    ...
    {
        Schema::dropIfExists('pembelian_biller_kartu_perdana');
    }
};

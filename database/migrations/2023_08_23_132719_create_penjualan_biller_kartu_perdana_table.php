...
return new class extends Migration
{
    ...
    {
        Schema::create('penjualan_biller_kartu_perdana', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('biller_id');
            $table->foreign('biller_id')->references('id')->on('biller');
            $table->unsignedBigInteger('biller_kartu_perdana_id');
            $table->foreign('biller_kartu_perdana_id')->references('id')->on('biller_kartu_perdana');
    ...
    {
        Schema::dropIfExists('penjualan_biller_kartu_perdana');
    }
};

...
class BillerKartuPerdana extends Model
{
    use HasFactory;

    protected $table = 'biller_kartu_perdana';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function dealer_kartu_perdana(): BelongsTo
    {
        return $this->belongsTo(DealerKartuPerdana::class, 'dealer_kartu_perdana_id', 'id');
    }

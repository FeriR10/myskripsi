...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col">
                    <form class="form-inline" action="/penjualan-dealer-pulsa/filter-date">
                        @csrf
                        ...
                        <a href="/penjualan-dealer-pulsa" class="btn btn-warning ml-1">Refresh Data</a>
                    </form>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a href="/penjualan-dealer-pulsa/export-pdf" class="btn btn-primary">Export PDF</a>
                    @endif

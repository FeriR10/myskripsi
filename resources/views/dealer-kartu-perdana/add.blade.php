    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Tambah Dealer Kartu Perdana</h3>
            ...
            <div class="card-body">
                <form role="form" method="POST" action="/dealer-kartu-perdana/create">
                    {{ csrf_field() }}
                    <div class="card-body">
                        <div class="form-group">
                            <label>Kartu</label>
                            <select name="supplier_kartu_perdana_id" id="" class="form-control">
                                {{-- <option value="">Pilih Supplier</option> --}}
                                @foreach ($data_supplier_kartu_perdana as $upplier_kartu_perdana)
                                    <option value="{{ $upplier_kartu_perdana->id }}">Kartu {{ $upplier_kartu_perdana->kartu->nama }} Harga jual supplier Rp.{{ $upplier_kartu_perdana->harga_jual }} </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">

...
@section('title', 'Approved Supplier Pulsa')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Approved Supplier Pulsa</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Approved Supplier Pulsa</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <form class="form-inline" action="/approved-supplier-pulsa/filter-date">
                        @csrf
                        ...
                        <a href="/approved-supplier-pulsa" class="btn btn-warning ml-1">Refresh Data</a>
                    </form>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Approved Supplier Pulsa <strong></strong></h3>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif (auth()->user()->role_id == 2)
                                    @if ( $pembelian->status == 'pending' )    
                                        <a class="btn btn-warning btn-sm" href="/approved-supplier-pulsa/{{ $pembelian->id }}/approved"

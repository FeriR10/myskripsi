...
@section('title', 'Approved Dealer Pulsa')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Approved Dealer Pulsa</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Approved Dealer Pulsa</li>
                    </ol>
                </div>
            </div>
            <div class="row">
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Approved Dealer Pulsa <strong></strong></h3>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif (auth()->user()->role_id == 3)
                                    @if ( $pembelian->status == 'pending' )    
                                        <a class="btn btn-warning btn-sm" href="/approved-dealer-pulsa/{{ $pembelian->id }}/approved"

...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form role="form" method="POST" action="/biller-kartu-perdana/{{ $data_biller_kartu_perdana->id }}/create-tambah-stok">
                    {{ csrf_field() }}
                    <div class="card-body">
                        <div class="form-group">
                            <label>Keterangan</label>
                            <input type="text" name="jumlah_transaksi" class="form-control" placeholder="Enter Jumlah Transaksi" value="Kartu {{ $data_biller_kartu_perdana->kartu->nama }} | Sisa Jumlah Transaksi {{ $data_biller_kartu_perdana->jumlah_transaksi }}" readonly>
                        </div>
                        <div class="form-group">
